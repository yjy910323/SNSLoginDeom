...
public class DoubanAccessServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//oauth.setRedirectUrl(URLEncoder.encode("http://127.0.0.1:8080/SNSLogin/weibo_login",("UTF-8")));
			AccessToken at = oauth.tradeAccessTokenWithCode(code);
			System.out.println(at.getAccessToken()+" "+at.getRefreshToken());
